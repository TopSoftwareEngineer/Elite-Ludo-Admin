...
Route::group(['middleware' => 'admin_auth'], function () {
    Route::prefix('admin')->group(function () {
        ...
        Route::post('/home/contacttext/updated/text', [FrontController::class, 'ContactTextUpdate'])->name('update.contactdetails.text');
...
//now front routing
//Route::get('/razorpay/payment',[RazorpayController::class,'SelectGateway']);
