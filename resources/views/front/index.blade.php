...
<body>
    ...
    <!-- about section -->
    <section id="about" class="fea-area about-area about-area3">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 margin-bottom-30 wow fadeInLeft">
                    <div class="" style="margin-left:-150px">
                        <img class="main-img" src="{{ url('/') }}/storage/Brand/{{ $home->about_img }}" style="width: 800px">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 wow fadeInRight">
                    <div class="fea-right">
                        <div class="common-title">
                            ...
                            <div class="fea-box">
                                <ul>
                                    <li><span><i class="fas fa-angle-double-right"></i></span> {{ $home->about_setp1 }}</li>

                                    <li><span><i class="fas fa-angle-double-right"></i></span>{{ $home->about_step2 }}
                                    </li>
                                    <li><span><i class="fas fa-angle-double-right"></i></span> {{ $home->about_step3 }}
                                    </li>
                                </ul>
                                <a class="template-btn3" href="{{ url('/') }}/about-us">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- features section -->
    <section id="feature" class="service-area features-section padding-top-80 padding-bottom-90">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".2s">
                    <div class="single-service-3 single-service">
                        <div class="ser-icon">
                            <img class="main-img" src="{{ url('/') }}/storage/Brand/{{ $home->easy_icon }}" >
                        </div>
                        <div class="ser-content">
                            <h4>{{ $home->easy_title }}</h4>
                            <p>{{ $home->easy_desc }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".4s">
                    <div class="single-service-3 single-service">
                        <div class="ser-icon">
                            <img class="main-img" src="{{ url('/') }}/storage/Brand/{{ $home->de_icon }}" >
                        </div>
                        <div class="ser-content">
                            <h4>{{ $home->de_title }}</h4>
                            <p>{{ $home->de_desc }}</p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".6s">
                    <div class="single-service-3 single-service">
                        <div class="ser-icon">
                            <img class="main-img" src="{{ url('/') }}/storage/Brand/{{ $home->op_icon }}" >
                        </div>
                        <div class="ser-content">
                            <h4>{{ $home->op_title }}</h4>
                            <p>{{ $home->op_desc }}</p>
    ...
    <!-- download-area -->
    <section id="download" class="download-area download-area3">
        <div class="ddshapes">
            <img class="ddmain" alt="" src="{{ url('/') }}/front-assets/images/h-shape6.png">
        </div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 col-md-6 wow fadeInLeft">
                    <div class="download-left d-none d-lg-block">
                        <div class="dl-shapes">
                        </div>
                        <img class="main-img" src="{{ url('/') }}/storage/Brand/{{ $home->download_image }}" style="width:800px;margin-left:-100px" >
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 wow fadeInRight">
                    <div class="download-right">
                        <div class="common-title">
                            <h3>{{ $home->download_title }}</h3>
                            <p>{{ $home->download_desc }}</p>
                            <div class="btn-box d-flex">
                                <a href="{{ url('/') }}/storage/Brand/{{ $home->download_link }}" download><img src="{{ url('/') }}/front-assets/images/btn4.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- screenshot section -->
    <section id="screenshot" class="screenshot-area screenshot-area3 padding-top-100">
        <div class="screen-shapes">
            <img class="screen1" src="{{ url('/') }}/front-assets/images/ss1.png" alt="">
            <img class="screen2" src="{{ url('/') }}/front-assets/images/h-shape6.png" alt="">
        </div>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7 wow fadeInUp">
                    <div class="common-title common-title2 text-center">
                        <h3>{{ $home->screenshot_title }}</h3>
            ...
            <div class="ss-container">
                <div class="ss-active">
                        ...
                        <div class="ss-item">
                            <div class=""><img  src="{{ url('/') }}/storage/Screenshot/{{ $result->screenshot }}" style="width:600px"></div>
                        </div>
                        @endforeach
