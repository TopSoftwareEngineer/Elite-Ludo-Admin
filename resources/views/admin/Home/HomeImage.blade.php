            ...
            <ul class="nav nav-pills flex-column nav-left">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="account-pill-shipping" data-toggle="pill"
                        ...
                        <i class="las la-cloud-download-alt font-medium-3 mr-1"></i>
                        <span class="font-weight-bold">Download Section</span>
                    </a>
                </li>
                <!-- information -->
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="account-pill-contact" data-toggle="pill" href="#account-vertical-contact"
                        aria-expanded="false">
                        <i class="las la-address-card font-medium-3 mr-1"></i>
                        <span class="font-weight-bold">Contact Image</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="account-pill-uploadapk" data-toggle="pill" href="#account-vertical-uploadapk"
                        aria-expanded="false">
                        ...
                        <div class="tab-pane fade" id="account-vertical-contact" role="tabpanel"
                         ...
                         <form class="logo_setting" method="post" action="{{ route('update.uploadapk.icon') }}"
                             ...
                             <div class="row">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-4">
                                         <div class="favicon ml-5">
                                             ...
                                             <a href="{{ url('/') }}/storage/Brand/{{ $homedetails->download_link }}" download><i class="lab la-google-play ml-4 mt-2" style="font-size:50px;cursor:pointer"></i></a>
                                             @else
                                 ...
                                 <div class="col-12">
                                     <button type="submit" class="btn btn-primary mt-2 mr-1 float-right">Update APK</button>
                                 </div>
                             </div>
                         </form>
                         <!--/ form -->
