...
<button data-id="{{$data->userid}}" data-banned="{{$data->banned}}" class="btn-sm btn-danger mr-1 border-0 rounded-0 block_btn">Unblock</button>
                      ...
                      <a href="{{url('admin/player/withdraw/'.Crypt::encrypt($data->playerid))}}"><button class="btn-sm btn-danger mr-1 border-0 rounded-0 WithHistory">Withdraw History</button></a>
                      <button data-coin="{{$data->totalcoin}}" data-wincoin="{{$data->wincoin}}" data-id="{{$data->playerid}}" data-username="{{$data->username}}" class="btn-sm btn-primary mr-1 border-0 rounded-0 CutCoinButton mt-1" data-toggle="modal" data-target="#CutCoin">Deduct Coin</button>
                    </div>
